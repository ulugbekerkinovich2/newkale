...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://localhost/kale",
    ),
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "kale.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""Ulugbek Erkinov""", "ulugbek9015t@gmail.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "newkaleapi API",
    "DESCRIPTION": "Documentation of API endpoints of newkaleapi",
    "VERSION": "1.0.0",
